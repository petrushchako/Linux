...
- Reasons to Use Linux
    ...
    - **Free**
        ...
        1. No recurring licensing fees
        2. No initial cost for many distributions
        3. No corporate fees

    - **Stable**

        Linux is a very stable operating system; it is unusual for it to crash:
        1. Not prone to crash
    ...
    - **Secure**
        ...
        1. Linux viruses are not as prevalent as those on other operating systems
        2. Optional (still free) security enhancements from the NSA can be enabled
        3. Free antivirus software if required
    
    - **Maintainability**
    
        The Linux package management tools make it easy to update, add and remove software packages:
        1. Updating Linux distributions is straightforward and easy
        2. Uses public repositories maintained by various Linux providers
        3. If desired, the repository can be company-internal
    ...
    - **Easy to use**
        ...
        2. Several graphical desktop environments
        3. Easy to switch Desktop environments
    - **Support**

        1. It is community-supported
        2. Purchased support from some commercial linux vendors is also available (Red Hat, SUSE, Canonical, etc.)

    - **Open source**
        
        Linux is the largest open source project in the world, with the largest number of contributors.
        1. Everyone has access to view and modify Linux
        2. Linux uses the GPL2 license.
