...
There are several other intrusion detection applications besides aide. Some Intrusion Detection Systems (IDS) also include Intrusion Prevention Systems (IPS).

**IDS/IPS Systems Available in Linux:**

- **SELinux**

    [SELinux](https://www.redhat.com/en/topics/linux/what-is-selinux), or Security Enhanced Linux, can track and report on file, directory and network access. With the two modes of **permissive** and **enforcing**, application access errors can be detected and documented as errors or prohibit the function from occurring while in enforcing mode.

- **Open Source Tripwire**

    [Open Source Tripwire](https://github.com/Tripwire/tripwire-open-source) does the file change monitoring and sends a report.

- **Fail2ban**

    [Fail2ban](https://www.fail2ban.org/) scans log files per application configuration; it allows, for example, tracking on all ssh connections and bans connection requests for IPs that show malicious signs.

- **OSSEC**

    [OSSEC](https://www.ossec.net/about/) is a scalable, multi-platform, open source host-based IDS. It has detection and response capabilities. The detection and response configurations can be customized for your environment. OSSEC contains similar functionality as Tripwire and Fail2ban in one tool.

- **Snort**

    [Snort](https://www.snort.org/) is a network Intrusion Detection/Prevention system which can observe and report on network conditions and traffic.