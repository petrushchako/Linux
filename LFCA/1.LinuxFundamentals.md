...
|**chmod**|Change file mode bits (a.k.a.permissions). |
| ^ |The format can be in symbolic mode or octal mode (0-7).|
| ^ |Symbolic mode permissions: read (r),write (w), and execute (x).|
| ^ |Octal mode permissions: read (4), write (2), and execute (1).|
